...
The Visualizer is the console's dashboard surface: a resizable grid of widgets, each bound to a NATS subject, a JetStream consumer, or a KV key. It is the screen you put in front of someone who does not administer the platform — a technician watching a site, or an unattended display in a control room.
...
Sixteen of them. The grid is 12 columns wide, and each type has a sensible default size.
